...
#find out the sales total purchase every month
...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    final_sales_team_data_mart=final_sales_team_data_mart_df \
        ...
        col("sales_person_last_name")).alias("full_name"),"sales_month","total_sales_every_month").distinct()
    ...
    #Write the data into MySQL customer_data_mart_table
